...
<h4 align="center">A powerful, easy to use and intuitive way to create network analysis charts.</h4>
  ...
  [![Test](https://img.shields.io/github/actions/workflow/status/diggsweden/mla/test.yml?style=for-the-badge)](https://github.com/diggsweden/mla/actions/workflows/test.yml)
