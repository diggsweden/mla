          ...
          {historyView.map(function (m, i) {
            if (m.separator && m.rubrik) {
              return (
                <div
                  key={i}
                  className="m-ml-4 m-pb-3 m-font-semibold m-text-center m-relative m-cursor-pointer"
                  onClick={() => {
                    if (m.event != null) {
                ...
                >
                  <div
                    className="m-text-white m-w-full m-px-3 m-bg-origin-border m-bg-no-repeat m-ms-auto m-me-auto"
                    style={{
                      backgroundImage: "conic-gradient(from 45deg at left center, rgb(68, 105, 149) 25%, rgba(0, 0, 0, 0) 0deg), conic-gradient(from -135deg at right center, rgb(68, 105, 149) 25%, rgba(0, 0, 0, 0) 0deg)",
                      backgroundPositionX: "0px, 100%",
                      backgroundPositionY: "50%, 50%",
                      backgroundSize: "51% 100%",
                      borderImageSource: "linear-gradient(rgba(0, 0, 0, 0) calc(50% - 2px), rgb(196, 77, 88) 0px, rgb(196, 77, 88) calc(50% + 2px), rgba(0, 0, 0, 0) 0px)",
                    }}
                    title={toDateString(m.date)}
                  >
                    <div className="m-w-full m-flex m-p-1">
                      <span className="m-flex-1">{m.rubrik}</span>
                      <span
                        className="m-ms-2 m-w-4"
                        title={t("edit")}
                        onClick={() => {
                          if (m.event != null) {
              ...
              return (
                <div
                  className="m-w-full m-flex m-pb-3 m-cursor-pointer m-"
                  key={i}
                  onClick={() => {
                    selected(m);
                  }}
                >
                  ...
                  <div className="m-border m-bg-white m-w-full m-p-2 m-ms-1">
                    <div className="m-text-primary m-text-sm m-font-bold">
                      {toDateAndTimeString(m.date)} - {m.rubrik}
                    </div>
